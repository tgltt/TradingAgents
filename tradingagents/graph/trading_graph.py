...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        elif config_llm_provider == "google":
            google_api_key = self._get_api_key(config_llm_provider)
        ...
        elif config_llm_provider == "dashscope" or "dashscope" in config_llm_provider or "alibaba" in config_llm_provider:
    ...
    def _create_tool_nodes(self) -> Dict[str, ToolNode]:
        ...
        return {
            ...
            "fundamentals": ToolNode(
                [
                    # online tools
                    self.toolkit.get_fundamentals_tushare
                    # offline tools
                ]
            ),
        }
