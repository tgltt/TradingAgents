...
DEFAULT_CONFIG = {
    ...
    "results_dir": os.getenv("TRADINGAGENTS_RESULTS_DIR", os.path.join("./", "output", "results")),
    ...
    # For ChatGPT: set llm_provider="openai", deep_think_llm="o4-mini", quick_think_llm="gpt-4o-mini", backend_url="https://api.openai.com/v1"
    # For DashScope: set llm_provider="dashscope", deep_think_llm="qwen-plus", quick_think_llm="qwen-turbo"
    "llm_provider": "zhipu",
    "deep_think_llm": "glm-4.7-flash",
    "quick_think_llm": "GLM-4-Flash-250414",
