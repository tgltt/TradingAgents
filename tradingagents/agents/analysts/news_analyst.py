...
def create_news_analyst(llm, toolkit):
    def news_analyst_node(state):
        ...
        if toolkit.config["online_tools"]:
            tools = [toolkit.get_stock_news_sina, toolkit.get_baidu_news]
        else:
            tools = [
...
## 业务逻辑
1、调用工具get_stock_news_sina，从新浪财经股票频道，获取公司相关新闻;
2、调用工具get_baidu_news，从百度搜索引擎获取公司相关的新闻;
3、融合新浪财经股票频道和百度搜索引擎两个来源的公司新闻；
4、根据获取到的公司新闻，分析公司经营情况，给出具有浅析分析逻辑和明确结论;
