...
def get_company_notice_list_sina(stock_code, max_count=10):
    """
    获取上市公司最新新闻，目前只读取新浪财经股票新闻第一页的新闻列表。
    Args:
        stock_code (str): 上市公司股票代码
        max_count (int, optional): 最多返回的公告数. 默认10.
...
def get_company_notice_detail_sina(new_url):
...
data = get_company_notice_list_sina("301176", 3)
print(data)
